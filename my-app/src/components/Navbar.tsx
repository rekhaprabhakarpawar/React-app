...
const Navbar = (props: searchProp) => {
  ...
  return (
    <>
      <div className="flex p-4 bg-purple-100 shadow-lg">
        <img src={OLX1} className="w-11 h-9" />
        <div className="flex border-2 border-spacing-1 w-89 p-2 border-black ml-5 bg-white">
          <img src={lens} className="w-6 h-5 mt-1" />
          <input placeholder="Location" className="ml-3 outline-none " />
          <img src={arrow} className="w-8 h-7 mr-5" />
        </div>
